...
export const HOOK_VIDEO_MODELS: VideoModelSpec[] = [
  ...
  },
  {
    ...
    provider: "seedance",
    badge: "TOP",
    description: "Bytedance Seedance 2.0 — text/reference generation, 480p-4k, 4-15s, and native audio.",
    maxRefImages: 9,
    maxRefVideos: 3,
  ...
  },
  {
    ...
    provider: "seedance",
    badge: "FAST",
    description: "Bytedance Seedance 2.0 Turbo — text/reference generation, 720p/1080p, 4-15s, and native audio.",
    maxRefImages: 9,
    maxRefVideos: 3,
    maxRefVideoSeconds: 15,
    maxRefAudios: 3,
  ...
  },
  {
    ...
    provider: "seedance",
    badge: "NEW",
    description: "Bytedance Seedance 2.0 Mini — text/reference generation, 480p-4k, 4-15s, and native audio.",
    maxRefImages: 9,
    maxRefVideos: 3,
    maxRefVideoSeconds: 15,
    maxRefAudios: 3,
  ...
  },
  {
    ...
    apiRoute: "bytedance/seedance-2.0-fast/text-to-video",
    provider: "seedance",
    badge: "FAST",
