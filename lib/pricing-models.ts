...
export const DEFAULT_MODELS: PricingModel[] = [
  ...
  { id:"minimax_h3_max", name:"Minimax H3 Max",         notes:"WaveSpeed $0.14/s + 40% margin", type:"video", provider:"wavespeed", billing:"per_sec", kieCredits:0, waveUsd:0.14, userCreditsRate:7.84, maxDuration:15, isActive:true },
  { id:"minimax_h3_max_turbo", name:"Minimax H3 Max Turbo", notes:"WaveSpeed $0.12/s + 40% margin", type:"video", provider:"wavespeed", billing:"per_sec", kieCredits:0, waveUsd:0.12, userCreditsRate:6.72, maxDuration:15, isActive:true },
  { id:"hailuo23",      name:"MiniMax Hailuo 2.3",      notes:"WaveSpeed fixed $0.49/5s (27.44 cr)", type:"video", provider:"wavespeed", billing:"flat", kieCredits:0, waveUsd:0.49, userCreditsRate:27.44, maxDuration:5, isActive:true },
  ...
  { id:"hailuo02",      name:"MiniMax Hailuo 02",       notes:"WaveSpeed Pro 6s: $0.48 (26.88 cr)", type:"video", provider:"wavespeed", billing:"flat", kieCredits:0, waveUsd:0.48, userCreditsRate:26.88, maxDuration:6, isActive:true },
  { id:"minimax_live_illustrations", name:"MiniMax Live Illustrations", notes:"WaveSpeed fixed $0.25/5s (14 cr)", type:"video", provider:"wavespeed", billing:"flat", kieCredits:0, waveUsd:0.25, userCreditsRate:14.0, maxDuration:5, isActive:true },
  ...
  { id:"minimax_h3",    name:"Minimax H3",              notes:"768p: $0.10/s, 2k: $0.14/s + 40% margin", type:"video", provider:"wavespeed", billing:"per_sec", kieCredits:0, waveUsd:0.10, userCreditsRate:5.6, maxDuration:15, isActive:true },
  ...
  { id:"gemini_omni_flash", name:"Gemini Omni Flash",    notes:"Higgsfield-aligned user schedule: 360p 1cr/s, 720p 3cr/s, 1080p 4.5cr/s, 4K 9cr/s", type:"cinema", provider:"kie", billing:"per_sec", kieCredits:0, waveUsd:0, userCreditsRate:3.0, maxDuration:10, isActive:true },
  ...
  { id:"seedream5p",    name:"Seedream 5.0 Pro T2I",    notes:"T2I",          type:"image",  provider:"wavespeed", billing:"flat",    kieCredits:0,     waveUsd:0.045, userCreditsRate:1.0,   maxDuration:null, isActive:true  },
  { id:"seedream5pi",   name:"Seedream 5.0 Pro I2I",    notes:"I2I",          type:"image",  provider:"wavespeed", billing:"flat",    kieCredits:0,     waveUsd:0.045, userCreditsRate:1.0,   maxDuration:null, isActive:true  },
