...
export const DEFAULT_MODELS: PricingModel[] = [
  ...
  { id:"seedance2",     name:"Seedance 2.0",            notes:"HQ",           type:"video",  provider:"kie",       billing:"per_sec", kieCredits:41.0,  waveUsd:0,     userCreditsRate:55 / 15,  maxDuration:15,   isActive:true  },
  ...
  { id:"seedream5p",    name:"Seedream 5.0 Pro T2I",    notes:"T2I",          type:"image",  provider:"kie",       billing:"flat",    kieCredits:6.0,   waveUsd:0,     userCreditsRate:1.0,   maxDuration:null, isActive:true  },
  { id:"seedream5pi",   name:"Seedream 5.0 Pro I2I",    notes:"I2I",          type:"image",  provider:"kie",       billing:"flat",    kieCredits:8.0,   waveUsd:0,     userCreditsRate:1.0,   maxDuration:null, isActive:true  },
