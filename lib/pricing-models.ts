...
export const DEFAULT_MODELS: PricingModel[] = [
  ...
  { id:"kling_v3_turbo", name:"Kling V3 Turbo",         notes:"WaveSpeed Turbo Std measured at $0.1064/s over three invoices (10s=$1.064, 15s=$1.596, 10s=$1.064); the old $0.02128/s was 5x low and sold the model below cost. Std 3.5 cr/s, Pro 4.4 cr/s.", type:"video", provider:"wavespeed", billing:"per_sec", kieCredits:10.0, waveUsd:0.1064, userCreditsRate:3.5, maxDuration:15, isActive:true },
