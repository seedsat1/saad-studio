...
export const DEFAULT_MODELS: PricingModel[] = [
  ...
  { id:"kling_v3_turbo", name:"Kling V3 Turbo",         notes:"WaveSpeed Turbo Std measured at $0.1064/s over three invoices (10s=$1.064, 15s=$1.596, 10s=$1.064); the old $0.02128/s was 5x low and sold the model below cost. Std 4.0 cr/s, Pro 5.0 cr/s.", type:"video", provider:"wavespeed", billing:"per_sec", kieCredits:10.0, waveUsd:0.1064, userCreditsRate:4.0, maxDuration:15, isActive:true },
  ...
  { id:"hailuo02_fast", name:"MiniMax Hailuo 02 Fast",  notes:"WaveSpeed 6s: $0.10 (5.60 cr), 10s: $0.15 (8.40 cr)", type:"video", provider:"wavespeed", billing:"flat", kieCredits:0, waveUsd:0.10, userCreditsRate:5.60, maxDuration:10, isActive:true },
