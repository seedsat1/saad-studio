...
export const DEFAULT_MODELS: PricingModel[] = [
  ...
  { id:"gpt2t",         name:"GPT Image 2 T2I",         notes:"1K/2K/4K",     type:"image",  provider:"kie",       billing:"flat",    kieCredits:6,     waveUsd:0,     userCreditsRate:3,    maxDuration:null, isActive:true  },
  { id:"gpt2i",         name:"GPT Image 2 I2I",         notes:"1K/2K/4K",     type:"image",  provider:"kie",       billing:"flat",    kieCredits:7,     waveUsd:0,     userCreditsRate:3,    maxDuration:null, isActive:true  },
  ...
  { id:"kling_o1_img",   name:"Kling 01 Image",          notes:"$0.028/run",   type:"image",  provider:"wavespeed", billing:"flat",    kieCredits:0,     waveUsd:0.028, userCreditsRate:6,    maxDuration:null, isActive:true  },
