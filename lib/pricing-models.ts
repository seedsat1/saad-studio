...
export const DEFAULT_MODELS: PricingModel[] = [
  ...
  { id:"kling30",       name:"Kling 3.0",               notes:"std",          type:"video",  provider:"kie",       billing:"per_sec", kieCredits:11.6,  waveUsd:0,     userCreditsRate:6.0,  maxDuration:15,   isActive:true  },
  // Kling 3.0 Omni / Omni Edit removed — not provided by KIE (see kie-model-routing.ts).
  { id:"kling30_mc",    name:"Kling 3.0 Motion Control", notes:"motion",      type:"video",  provider:"kie",       billing:"per_sec", kieCredits:16.4,  waveUsd:0,     userCreditsRate:5.0,  maxDuration:15,   isActive:true  },
  { id:"kling25t",      name:"Kling 2.5 Turbo",         notes:"fast",         type:"video",  provider:"kie",       billing:"per_sec", kieCredits:8.0,   waveUsd:0,     userCreditsRate:2.5,  maxDuration:10,   isActive:true  },
  { id:"hailuo23f",     name:"Hailuo 2.3 Fast",         notes:"fast",         type:"video",  provider:"kie",       billing:"per_sec", kieCredits:6.0,   waveUsd:0,     userCreditsRate:1.8,  maxDuration:10,   isActive:true  },
  { id:"hailuo23",      name:"Hailuo 2.3",              notes:"pro",          type:"video",  provider:"kie",       billing:"per_sec", kieCredits:10.0,  waveUsd:0,     userCreditsRate:3.0,  maxDuration:10,   isActive:true  },
  { id:"grok_vid",      name:"Grok Imagine Video",      notes:"T2V/I2V",      type:"video",  provider:"kie",       billing:"per_sec", kieCredits:9.0,   waveUsd:0,     userCreditsRate:2.7,  maxDuration:20,   isActive:true  },
  { id:"seedance2f",    name:"Seedance 2.0 Fast",       notes:"fast",         type:"video",  provider:"kie",       billing:"per_sec", kieCredits:7.0,   waveUsd:0,     userCreditsRate:2.1,  maxDuration:15,   isActive:true  },
  { id:"seedance2",     name:"Seedance 2.0",            notes:"HQ",           type:"video",  provider:"kie",       billing:"per_sec", kieCredits:11.0,  waveUsd:0,     userCreditsRate:3.3,  maxDuration:15,   isActive:true  },
  ...
  { id:"sora2_i2v",     name:"Sora 2 I2V",              notes:"img2vid",      type:"cinema", provider:"kie",       billing:"per_sec", kieCredits:22.0,  waveUsd:0,     userCreditsRate:6.6,  maxDuration:10,   isActive:true  },
  { id:"sora2_pro",     name:"Sora 2 Pro",              notes:"15s max",      type:"cinema", provider:"kie",       billing:"per_sec", kieCredits:30.0,  waveUsd:0,     userCreditsRate:9.0,  maxDuration:15,   isActive:true  },
  ...
  // ── IMAGE — flat via KIE ────────────────────────────────────────────────────
  { id:"nano_pro",      name:"Nano Banana Pro",         notes:"4K I2I",       type:"image",  provider:"kie",       billing:"flat",    kieCredits:4,     waveUsd:0,     userCreditsRate:8,    maxDuration:null, isActive:true  },
  { id:"nano2",         name:"Nano Banana 2",           notes:"T2I",          type:"image",  provider:"kie",       billing:"flat",    kieCredits:3.5,   waveUsd:0,     userCreditsRate:4,    maxDuration:null, isActive:true  },
  ...
  { id:"nano_edit",     name:"Nano Banana Edit",        notes:"edit",         type:"image",  provider:"kie",       billing:"flat",    kieCredits:4,     waveUsd:0,     userCreditsRate:3,    maxDuration:null, isActive:true  },
  ...
  { id:"imagen4",       name:"Google Imagen 4",         notes:"HQ",           type:"image",  provider:"kie",       billing:"flat",    kieCredits:6,     waveUsd:0,     userCreditsRate:3,    maxDuration:null, isActive:true  },
  { id:"imagen4u",      name:"Google Imagen 4 Ultra",   notes:"Ultra",        type:"image",  provider:"kie",       billing:"flat",    kieCredits:12,    waveUsd:0,     userCreditsRate:4,    maxDuration:null, isActive:true  },
  ...
  { id:"gpt2t",         name:"GPT Image 2 T2I",         notes:"1K/2K/4K",     type:"image",  provider:"kie",       billing:"flat",    kieCredits:6,     waveUsd:0,     userCreditsRate:8,    maxDuration:null, isActive:true  },
  { id:"gpt2i",         name:"GPT Image 2 I2I",         notes:"1K/2K/4K",     type:"image",  provider:"kie",       billing:"flat",    kieCredits:7,     waveUsd:0,     userCreditsRate:8,    maxDuration:null, isActive:true  },
  ...
  { id:"flux2_pro_t",   name:"FLUX.2 Pro T2I",          notes:"hidden",       type:"image",  provider:"kie",       billing:"flat",    kieCredits:3,     waveUsd:0,     userCreditsRate:4,    maxDuration:null, isActive:true  },
  { id:"flux2_pro_i",   name:"FLUX.2 Pro I2I",          notes:"hidden",       type:"image",  provider:"kie",       billing:"flat",    kieCredits:3,     waveUsd:0,     userCreditsRate:4,    maxDuration:null, isActive:true  },
