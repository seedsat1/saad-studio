...
export const DEFAULT_MODELS: PricingModel[] = [
  ...
  { id:"veo31_lite",    name:"Saad Studio Video 3.1 Lite", notes:"fast",      type:"cinema", provider:"kie",       billing:"per_sec", kieCredits:10.0,  waveUsd:0,     userCreditsRate:3.5,  maxDuration:8,    isActive:true  },
  { id:"veo31_fast",    name:"Saad Studio Video 3.1 Fast", notes:"8s",        type:"cinema", provider:"kie",       billing:"per_sec", kieCredits:10.0,  waveUsd:0,     userCreditsRate:4.0,  maxDuration:8,    isActive:true  },
  { id:"veo31",         name:"Saad Studio Video 3.1",      notes:"HQ 8s",     type:"cinema", provider:"kie",       billing:"per_sec", kieCredits:31.25, waveUsd:0,     userCreditsRate:10.0, maxDuration:8,    isActive:true  },
  // ── IMAGE — flat via KIE ────────────────────────────────────────────────────
