...
const APP_CATEGORIES_RAW: AppCategory[] = [
  {
    ...
    tools: [
      ...
      { id: "storyboard-studio", title: "Storyboard Studio", description: "Multi-panel storyboards with perspective control from one image", href: "/storyboard", badge: "NEW", gradient: "from-cyan-600/30 to-violet-900/30" },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "ai-stylist", title: "AI Stylist", description: "Your AI fitting room — try on outfits, change poses, swap backgrounds", href: "/apps/tool/ai-stylist", badge: "NEW", gradient: "from-fuchsia-600/30 to-pink-900/30" },
      { id: "outfit-swap", title: "Outfit Swap", description: "Transfer clothing from a reference image onto your photo", href: "/apps/tool/outfit-swap", badge: "NEW", gradient: "from-rose-600/30 to-pink-900/30" },
      { id: "outfit-vending", title: "Outfit Vending", description: "Display an outfit breakdown in an illuminated vending-machine layout", href: "/apps/tool/outfit-vending", badge: "NEW", gradient: "from-amber-600/30 to-yellow-900/30" },
      { id: "outfit-shot", title: "Outfit Shot", description: "Turn any outfit into a professional AI avatar photoshoot with natural poses", href: "/apps/tool/outfit-shot", badge: "NEW", gradient: "from-teal-600/30 to-cyan-900/30" },
      { id: "glitter-sticker", title: "Glitter Sticker", description: "Turn portraits into sparkling holographic stickers on urban surfaces", href: "/apps/tool/glitter-sticker", badge: "NEW", gradient: "from-purple-600/30 to-fuchsia-900/30" },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "cinematic-styles", title: "Cinematic Styles", description: "Layered motion presets for short-form edits", href: "/apps/tool/cinematic-styles", badge: "NEW", gradient: "from-cyan-600/30 to-indigo-900/30" },
    ],
  },
  {
    id: "ads-products",
