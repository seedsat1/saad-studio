...
const APP_CATEGORIES_RAW: AppCategory[] = [
  {
    ...
    tools: [
      ...
      { id: "ws-angles", title: "Image Angles", description: "Generate new camera angles from a single photo — rotate, tilt, shift perspective", href: "/apps/tool/", badge: "NEW", gradient: "from-emerald-600/30 to-teal-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419040908_e3bfye1z.webp" },
      { id: "ws-whats-next", title: "What's Next", description: "Explore what happens next in your scene — AI generates narrative continuations", href: "/apps/tool/", badge: "NEW", gradient: "from-pink-600/30 to-rose-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419040914_5lji484s.webp" },
      { id: "ws-shots", title: "Shots", description: "Transform one photo into unique cinematic shots — different compositions", href: "/apps/tool/", badge: "TOP", gradient: "from-amber-600/30 to-orange-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419040919_6xiuzk4p.webp" },
      { id: "ws-zooms", title: "Zooms", description: "Create dynamic zoom variations — from macro close-ups to wide-angle perspectives", href: "/apps/tool/", badge: null, gradient: "from-sky-600/30 to-blue-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419040925_6dfq412f.webp" },
      { id: "ws-behind-the-scenes", title: "Behind the Scenes", description: "Turn any photo into a behind-the-scenes film set reveal — cameras, crew", href: "/apps/tool/", badge: null, gradient: "from-purple-600/30 to-violet-900/30" },
    ],
  },
  {
    id: "enhance-style",
    ...
    tools: [
      ...
      { id: "ws-ai-stylist", title: "AI Stylist", description: "Your AI fitting room — try on outfits, change poses, and swap backgrounds instantly", href: "/apps/tool/", badge: "HOT", gradient: "from-violet-600/30 to-purple-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419040951_bib7n60p.webp" },
      { id: "ws-relight", title: "Relight", description: "Adjust lighting position, color temperature, and brightness to perfect any photo", href: "/apps/tool/", badge: "PRO", gradient: "from-amber-600/30 to-orange-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419040955_t7nokwco.webp" },
      { id: "ws-skin-enhancer", title: "Skin Enhancer", description: "Smooth skin and remove blur from portraits — natural, realistic skin textures", href: "/apps/tool/", badge: "PRO", gradient: "from-rose-600/30 to-pink-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041000_ffy8jjhj.webp" },
      { id: "ws-outfit-swap", title: "Character Outfit Swap", description: "Try on any outfit with a single photo — transfer clothing from a reference image", href: "/apps/tool/", badge: "NEW", gradient: "from-cyan-600/30 to-indigo-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041005_c2wezbra.webp" },
      { id: "ws-style-snap", title: "Style Snap", description: "Transform your look with instant style variations — swap outfits while keeping your pose", href: "/apps/tool/", badge: "TRENDING", gradient: "from-indigo-600/30 to-violet-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041010_jror5emv.webp" },
    ],
  },
  {
    id: "face-identity",
    ...
    tools: [
      ...
      { id: "ws-character-recast", title: "Character Recast", description: "Industry-leading character swap for any video — replace the entire persona", href: "/apps/tool/", badge: "PRO", gradient: "from-emerald-600/30 to-teal-900/30" },
      { id: "ws-character-swap", title: "Character Swap", description: "Seamlessly place a new character into any scene — maintain identity across poses", href: "/apps/tool/", badge: "NEW", gradient: "from-violet-600/30 to-purple-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041035_9ishqteh.webp" },
      { id: "ws-face-swap", title: "Face Swap", description: "Instant AI face swap for photos — seamlessly integrate new faces into any image", href: "/apps/tool/", badge: "TOP", gradient: "from-cyan-600/30 to-blue-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041040_yjyr75i0.webp" },
      { id: "ws-commercial-faces", title: "Commercial Faces", description: "Generate ad-ready spokesperson imagery — professional face transformations for marketing", href: "/apps/tool/", badge: "PRO", gradient: "from-pink-600/30 to-rose-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041044_wmxjkzs8.webp" },
      { id: "ws-video-face-swap", title: "Video Face Swap", description: "Best-in-class face swapping for any video — frame-by-frame accuracy", href: "/apps/tool/", badge: "HOT", gradient: "from-sky-600/30 to-blue-900/30" },
    ],
  },
  {
    id: "video-editing",
    ...
    tools: [
      ...
      { id: "ws-clipcut", title: "ClipCut", description: "Turn one selfie into an instant outfit reel — AI fashion montage synced to music", href: "/apps/tool/", badge: "TOP", gradient: "from-cyan-600/30 to-teal-900/30" },
      { id: "ws-urban-cuts", title: "Urban Cuts", description: "Next-gen beat-synced AI outfit videos — dynamic cuts perfectly timed to music", href: "/apps/tool/", badge: "TRENDING", gradient: "from-violet-600/30 to-purple-900/30" },
      { id: "ws-sticker-matchcut", title: "Sticker Match Cut", description: "Turn any clip into a sparkling sticker animation — glittering holographic frames", href: "/apps/tool/", badge: "NEW", gradient: "from-amber-600/30 to-yellow-900/30" },
      { id: "ws-breakdown", title: "Breakdown", description: "Split any image into its individual components — AI identifies objects, brands", href: "/apps/tool/", badge: null, gradient: "from-orange-600/30 to-amber-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041114_gf8rdom6.webp" },
      { id: "ws-japanese-show", title: "Japanese Show", description: "Turn your photo into a retro 2000s Japanese variety show — CRT scanlines", href: "/apps/tool/", badge: "TRENDING", gradient: "from-rose-600/30 to-red-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041120_dyhq2hxz.webp" },
    ],
  },
  {
    id: "ads-products",
    ...
    tools: [
      ...
      { id: "ws-click-to-ad", title: "Click to Ad", description: "Character interacts with your product in a dynamic video ad", href: "/apps/tool/", badge: "HOT", gradient: "from-amber-600/30 to-orange-900/30" },
      { id: "ws-asmr-add-on", title: "ASMR Add-On", description: "Character whispers about your product in an intimate ASMR video", href: "/apps/tool/", badge: "NEW", gradient: "from-indigo-600/30 to-blue-900/30" },
      { id: "ws-asmr-classic", title: "ASMR Classic", description: "Classic ASMR product video — gentle touching, tapping, and rotating", href: "/apps/tool/", badge: null, gradient: "from-teal-600/30 to-cyan-900/30" },
      { id: "ws-poster", title: "Poster", description: "Generate a professional marketing poster for your product", href: "/apps/tool/", badge: "TOP", gradient: "from-violet-600/30 to-purple-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041249_rx4nxp5e.webp" },
      { id: "ws-bullet-time-scene", title: "Bullet Time Scene", description: "Freeze-frame bullet-time effect with character and product", href: "/apps/tool/", badge: "PRO", gradient: "from-slate-600/30 to-blue-900/30" },
    ],
  },
  {
    id: "games-fun",
    ...
    tools: [
      ...
      { id: "ws-game-dump", title: "Game Dump", description: "Transform yourself into iconic video game styles — become a gaming hero", href: "/apps/tool/", badge: "TOP", gradient: "from-violet-600/30 to-purple-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041131_litfc4gk.webp" },
      { id: "ws-nano-strike", title: "Nano Strike", description: "AI tactical shooter character — transform into a battle-ready operator with full gear", href: "/apps/tool/", badge: null, gradient: "from-slate-500/30 to-gray-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041137_cdzf0e2b.webp" },
      { id: "ws-nano-theft", title: "Nano Theft", description: "See yourself in a realistic open-world crime game — GTA-inspired character art", href: "/apps/tool/", badge: "TRENDING", gradient: "from-amber-600/30 to-orange-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041142_zbybimy6.webp" },
      { id: "ws-simlife", title: "Simlife", description: "Transform into a stylized life simulation character — The Sims-inspired avatar", href: "/apps/tool/", badge: null, gradient: "from-emerald-600/30 to-green-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041148_itfh9s28.webp" },
      { id: "ws-plushies", title: "Plushies", description: "Transform any photo into an adorable plushie-style character — soft toy animation", href: "/apps/tool/", badge: "NEW", gradient: "from-pink-600/30 to-rose-900/30", previewImage: "https://static.wavespeed.ai/static/2026-04-19/20260419041153_873fnsz7.webp" },
    ],
  },
  {
    id: "creative-effects",
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "ws-yes-kiss", title: "Yes Kiss", description: "Your photo gets kissed in a surreal, meme-style moment", href: "/apps/tool/", badge: "HOT", gradient: "from-pink-600/30 to-rose-900/30" },
      { id: "ws-latex", title: "Latex", description: "Transform your photo into a sleek black latex style", href: "/apps/tool/", badge: "TRENDING", gradient: "from-slate-500/30 to-gray-900/30" },
      { id: "ws-j-magazine", title: "J-Magazine", description: "Turn your photo into a Japanese magazine cover", href: "/apps/tool/", badge: "TRENDING", gradient: "from-red-600/30 to-rose-900/30" },
      { id: "ws-roller-coaster", title: "Roller Coaster", description: "Put your photo on a thrilling roller coaster ride", href: "/apps/tool/", badge: null, gradient: "from-orange-600/30 to-amber-900/30" },
      { id: "ws-60s-cafe", title: "60s Cafe", description: "Turn your photo into a vintage 60s cafe scene", href: "/apps/tool/", badge: "NEW", gradient: "from-yellow-600/30 to-amber-900/30" },
    ],
  },
  {
    id: "extras",
    ...
    tools: [
      // ─── WaveSpeed Extras ───────────────────────────────────────────────
      {
        ...
        href: "/apps/tool/ws-virtual-try-on",
        badge: "HOT",
      ...
      },
      {
        ...
        href: "/apps/tool/ws-ai-instagram-model",
        badge: "NEW",
      ...
      },
      {
        ...
        href: "/apps/tool/ws-ai-music-video",
        badge: "HOT",
      ...
      },
      {
        ...
        href: "/apps/tool/ws-ai-image-translator",
        badge: "NEW",
      ...
      },
      {
        ...
        href: "/apps/tool/ws-ai-camera-angle",
        badge: "NEW",
