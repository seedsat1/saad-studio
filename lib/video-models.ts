...
export const VIDEO_MODELS: VideoModel[] = [
  ...
  // â”€â”€ HAILUO â”€â”€
  {
    ...
    creditCost: 47.04,
    maxDuration: 15,
    description: "Flagship multimodal video generation with maximum quality",
  },
  {
    ...
    creditCost: 40.32,
    maxDuration: 15,
    description: "Turbo-speed inference multimodal video generation",
  },
  {
    id: "minimax-h3",
    name: "Minimax H3",
    ...
    creditCost: 33.6,
    maxDuration: 15,
    description: "Multimodal video generation (50% off)",
  },
  {
    ...
    creditCost: 27.44,
    maxDuration: 10,
    description: "Flagship Hailuo 2.3 cinematic video generation",
  },
  {
  ...
  },
  {
    ...
    creditCost: 26.88,
    maxDuration: 10,
    description: "High fidelity video with start and end frame control",
  },
  {
    ...
    creditCost: 14.0,
    maxDuration: 10,
    description: "Animate illustrations and artwork into fluid motion",
  },
