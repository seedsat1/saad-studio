...
export class BackblazeProvider implements StorageProvider {
  ...
  constructor() {
    this.bucketName = process.env.R2_BUCKET || process.env.R2_BUCKET_NAME || "saadstudio-storage";
    ...
    this.client = new S3Client({
      region: process.env.R2_REGION || "eu-central-003",
      endpoint: process.env.R2_ENDPOINT || "https://s3.eu-central-003.backblazeb2.com",
      credentials: {
