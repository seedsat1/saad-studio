...
const SEED_CATEGORIES: CmsCategory[] = [
  {
    ...
    tools: [
      ...
      { _id: uid(), id: "storyboard-studio", title: "Storyboard Studio", description: "Multi-panel storyboards with perspective control from one image", href: "/storyboard", badge: "NEW", gradient: "from-cyan-600/30 to-violet-900/30" },
...
export default function AppsCmsPage() {
  ...
  return (
    <AdminShell activeRoute="/admin/cms/apps">
      <div className="w-full min-w-0 flex-1 text-slate-200 pb-12">
        {/* Top bar */}
