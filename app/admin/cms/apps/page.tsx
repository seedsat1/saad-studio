...
const SEED_CATEGORIES: CmsCategory[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { _id: uid(), id: "character-reference-sheet", title: "Character Reference Sheet", description: "Consistent identity sheet with multi-angle editorial frames", href: "/apps/tool/character-reference-sheet", badge: "NEW", gradient: "from-violet-600/30 to-indigo-900/30" },
      { _id: uid(), id: "model-reference-sheet", title: "Model Reference Sheet", description: "Three-view consistency: upper body, full front, full back", href: "/apps/tool/model-reference-sheet", badge: "NEW", gradient: "from-sky-600/30 to-blue-900/30" },
      { _id: uid(), id: "makeup-analysis-guide", title: "Makeup Analysis Guide", description: "High-consistency beauty angles for premium makeup evaluation", href: "/apps/tool/makeup-analysis-guide", badge: "NEW", gradient: "from-rose-600/30 to-pink-900/30" },
