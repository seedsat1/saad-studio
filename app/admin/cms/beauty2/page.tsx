...
const SEED_TOOLS: ToolCard[] = [
  { _id: uid(), toolId: "outfit-change", nameEn: "Outfit Change", nameAr: "تبديل الملابس", descAr: "ارفع صورتك واختر ستايل الملابس", category: "outfit", badge: "hot", thumb: "/img/beauty-tools/outfit-change.png", optionsCount: 8 },
  { _id: uid(), toolId: "evening-dress", nameEn: "Evening Dress", nameAr: "فساتين سهرة", descAr: "اختاري فستان السهرة المثالي", category: "outfit", badge: "pop", thumb: "/img/beauty-tools/evening-dress.png", optionsCount: 4 },
  { _id: uid(), toolId: "wedding-dress", nameEn: "Wedding Dress", nameAr: "فستان زفاف", descAr: "شوفي نفسك بفستان زفاف الأحلام", category: "outfit", badge: "pop", thumb: "/img/beauty-tools/wedding-dress.png", optionsCount: 4 },
  { _id: uid(), toolId: "traditional-wear", nameEn: "Traditional Wear", nameAr: "أزياء تقليدية", descAr: "اختر الزي التقليدي المفضل", category: "outfit", badge: "new", thumb: "/img/beauty-tools/traditional-wear.png", optionsCount: 4 },
  { _id: uid(), toolId: "hijab-style", nameEn: "Hijab Styling", nameAr: "ستايل حجاب", descAr: "اختاري طريقة لف الحجاب", category: "outfit", badge: "new", thumb: "/img/beauty-tools/hijab-styling.png", optionsCount: 4 },
  { _id: uid(), toolId: "cosplay", nameEn: "Cosplay", nameAr: "كوسبلاي", descAr: "تحوّل لشخصيتك المفضلة", category: "outfit", badge: "hot", thumb: "/img/beauty-tools/cosplay.png", optionsCount: 4 },
  { _id: uid(), toolId: "full-glam", nameEn: "Full Glam Makeup", nameAr: "ميكاب فل قلام", descAr: "اختاري ستايل الميكاب الكامل", category: "makeup", badge: "hot", thumb: "/img/beauty-tools/full-glam-makeup.png", optionsCount: 4 },
  { _id: uid(), toolId: "korean-beauty", nameEn: "Korean Beauty", nameAr: "ميكاب كوري", descAr: "لوك كوري ناعم — بشرة زجاجية", category: "makeup", badge: "hot", thumb: "/img/beauty-tools/korean-beauty.png", optionsCount: 3 },
  { _id: uid(), toolId: "arabic-makeup", nameEn: "Arabic Makeup", nameAr: "ميكاب عربي", descAr: "ميكاب عربي تقليدي درامي", category: "makeup", badge: "pop", thumb: "/img/beauty-tools/arabic-makeup.png", optionsCount: 3 },
  { _id: uid(), toolId: "lip-color", nameEn: "Lip Color Try-On", nameAr: "تجربة ألوان الروج", descAr: "اختاري لون الروج المفضل", category: "makeup", badge: "new", thumb: "/img/beauty-tools/lip-color-tryon.png", optionsCount: 5 },
  { _id: uid(), toolId: "eye-makeup", nameEn: "Eye Makeup", nameAr: "ميكاب عيون", descAr: "اختاري ستايل ميكاب العيون", category: "makeup", badge: "new", thumb: "/img/beauty-tools/eye-makeup.png", optionsCount: 4 },
  { _id: uid(), toolId: "bridal-makeup", nameEn: "Bridal Makeup", nameAr: "ميكاب عروس", descAr: "اختاري ستايل ميكاب العروسة", category: "makeup", badge: "pop", thumb: "/img/beauty-tools/bridal-makeup.png", optionsCount: 3 },
  { _id: uid(), toolId: "skin-retouch", nameEn: "Skin Retouch", nameAr: "تنعيم البشرة", descAr: "اختاري مستوى التنعيم", category: "makeup", badge: "new", thumb: "", optionsCount: 3 },
  { _id: uid(), toolId: "hairstyle", nameEn: "Hairstyle Change", nameAr: "تغيير قصة الشعر", descAr: "اختر القصة الجديدة", category: "hair", badge: "hot", thumb: "", optionsCount: 4 },
  { _id: uid(), toolId: "hair-color", nameEn: "Hair Color", nameAr: "لون الشعر", descAr: "اختر اللون الجديد", category: "hair", badge: "hot", thumb: "", optionsCount: 5 },
  { _id: uid(), toolId: "beard-style", nameEn: "Beard Styles", nameAr: "ستايل لحية", descAr: "اختر ستايل اللحية", category: "hair", badge: "new", thumb: "", optionsCount: 4 },
  { _id: uid(), toolId: "bangs", nameEn: "Bangs Try-On", nameAr: "تجربة غرة", descAr: "اختاري نوع الغرة", category: "hair", badge: "new", thumb: "", optionsCount: 4 },
  { _id: uid(), toolId: "braids", nameEn: "Braids & Updos", nameAr: "ضفائر وتسريحات", descAr: "اختاري التسريحة", category: "hair", badge: "new", thumb: "", optionsCount: 4 },
  { _id: uid(), toolId: "extensions", nameEn: "Hair Extensions", nameAr: "إكستنشن", descAr: "اختاري الطول والكثافة", category: "hair", badge: "new", thumb: "", optionsCount: 3 },
  { _id: uid(), toolId: "balayage", nameEn: "Balayage", nameAr: "بالاياج وهايلايت", descAr: "اختاري نوع التلوين", category: "hair", badge: "new", thumb: "", optionsCount: 3 },
  { _id: uid(), toolId: "lip-enhancement", nameEn: "Lip Enhancement", nameAr: "تكبير الشفايف", descAr: "اختاري حجم الشفايف المطلوب", category: "body", badge: "hot", thumb: "", optionsCount: 5 },
  { _id: uid(), toolId: "slim-body", nameEn: "Slim Body", nameAr: "تنحيف الجسم", descAr: "اختاري مستوى التنحيف", category: "body", badge: "pop", thumb: "", optionsCount: 3 },
  { _id: uid(), toolId: "muscle-enhance", nameEn: "Muscle Enhancement", nameAr: "إبراز العضلات", descAr: "اختر مستوى العضلات", category: "body", badge: "new", thumb: "", optionsCount: 3 },
  { _id: uid(), toolId: "nose-reshape", nameEn: "Nose Reshape", nameAr: "تعديل الأنف", descAr: "اختر الشكل المطلوب", category: "body", badge: "new", thumb: "", optionsCount: 4 },
  { _id: uid(), toolId: "skin-tan", nameEn: "Skin Tan", nameAr: "تسمير البشرة", descAr: "اختر درجة اللون", category: "body", badge: "new", thumb: "", optionsCount: 4 },
];
    ...
    <div className="rounded-2xl border border-white/10 bg-slate-900/60 overflow-hidden">
      <div className="flex items-center gap-3 p-3 cursor-pointer hover:bg-white/[.02] transition-colors" onClick={() => setOpen(!open)}>
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-zinc-500 truncate">{tool.nameAr} · {tool.category} · {tool.optionsCount} options</p>
        </div>
      ...
      {open && (
        <div className="p-4 pt-2 space-y-3 border-t border-white/5">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <Field label="Options #" value={tool.optionsCount} onChange={(v) => up({ optionsCount: Number(v) || 0 })} type="number" />
          </div>
          <Field label="Thumbnail URL" value={tool.thumb} onChange={(v) => up({ thumb: v })} placeholder="/img/beauty-tools/..." />
        </div>
      )}
    </div>
  );
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        if (b.tools?.length) setTools(b.tools);
      } catch { /* use seeds */ }
    })();
  }, []);
        ...
        <section className="space-y-4">
          ...
          <div className="flex items-center justify-end">
            <button onClick={() => setTools([...tools, {
              ...
              descAr: "وصف الأداة", category: "outfit", badge: "new", thumb: "", optionsCount: 4,
            }])}
