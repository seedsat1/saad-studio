...
const SEED_PLANS: CmsPlan[] = [
  { _id: uid(), id: "try", badge: "Try", tagline: "Test the studio with one quick taste", credits: "70 credits / mo", creditsNum: 70, equiv: "= 22 Nano Banana Pro images - ~1 Kling 3.0 video (8s)", monthlyPrice: 5, annualDiscount: 0, cta: "Try for $5", highlight: false, features: ["Selected model access", "1 video - 2 image parallel gens", "Try the full studio before committing"] },
...
const SEED_MODEL_COSTS: CmsModelCost[] = [
  ...
  { _id: uid(), name: "Seedance 2.0", cost: "32 / 120 Credits", per: "4s / 15s", type: "video" },
