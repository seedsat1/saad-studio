...
const SEED_CORE_TOOLS: CoreTool[] = [
  ...
  { _id: uid(), id: "soul-2", name: "Soul 2.0", desc: "Ultra-realistic fashion visuals", href: "/image/soul-id", badge: "NEW", image: "" },
  { _id: uid(), id: "soul-id", name: "Soul ID", desc: "Create unique characters", href: "/image/soul-id", badge: "", image: "" },
