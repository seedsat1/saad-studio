    ...
    <div className="flex h-screen overflow-hidden bg-slate-950 text-slate-100">
      ...
      <aside className="w-64 flex-shrink-0 flex flex-col border-r border-slate-800/80 bg-slate-900/70 backdrop-blur-sm">
        ...
        <div className="px-3 pb-3 space-y-0.5 border-b border-slate-800/80">
          ...
          {[
            { label: "Admin Control Center", href: "/admin/control-center", icon: Activity },
            { label: "AI Models Registry", href: "/admin/models", icon: Zap },
            { label: "Routing & Providers", href: "/admin/routing", icon: Cpu },
            { label: "Subscriber Usage Analytics", href: "/admin/subscriber-analytics", icon: TrendingUp },
            { label: "Provider Cost Tracking", href: "/admin/provider-costs", icon: DollarSign },
