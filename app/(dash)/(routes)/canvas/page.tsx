...
const NODE_LIBRARY_SECTIONS: Array<{ title: string; items: LibItem[] }> = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: "comic-layout"       as const, label: "Comic Layout",    icon: "📖",  color: "#f59e0b" },
    ],
  },
  {
    title: "CONTROL",
    items: [
      { type: "controlnet-canny"    as const, label: "ControlNet · Canny",    icon: "🧭",  color: "#f43f5e" },
      { type: "controlnet-depth"    as const, label: "ControlNet · Depth",    icon: "🏔️",  color: "#f43f5e" },
      { type: "controlnet-openpose" as const, label: "ControlNet · OpenPose", icon: "🕺",  color: "#f43f5e" },
      { type: "controlnet-lineart"  as const, label: "ControlNet · Lineart",  icon: "✒️",  color: "#f43f5e" },
      { type: "controlnet-scribble" as const, label: "ControlNet · Scribble", icon: "🖍️",  color: "#f43f5e" },
      { type: "ip-adapter"          as const, label: "IP-Adapter",            icon: "🎯",  color: "#fb7185" },
    ],
  },
  {
    title: "MASKS",
    items: [
      { type: "mask-sam"        as const, label: "Segment Anything", icon: "✂️",  color: "#eab308" },
      { type: "mask-grow"       as const, label: "Grow Mask",        icon: "🔍",  color: "#eab308" },
      { type: "mask-invert"     as const, label: "Invert Mask",      icon: "🔄",  color: "#eab308" },
      { type: "mask-from-color" as const, label: "Mask From Color",  icon: "🎨",  color: "#eab308" },
    ],
  },
  {
    title: "LOADERS",
    items: [
      { type: "checkpoint-loader" as const, label: "Checkpoint Loader", icon: "📂",  color: "#a855f7" },
      { type: "lora-loader"       as const, label: "LoRA Loader",       icon: "📦",  color: "#a855f7" },
    ],
  },
  {
    title: "FACE",
    items: [
      { type: "face-swap"       as const, label: "Face Swap",           icon: "🎭",  color: "#22c55e" },
      { type: "lipsync"         as const, label: "Lipsync",             icon: "👄",  color: "#22c55e" },
      { type: "head-animation"  as const, label: "Head Animation",      icon: "💫",  color: "#22c55e" },
      { type: "style-transfer"  as const, label: "Style Transfer (USO)", icon: "🎨",  color: "#22c55e" },
    ],
  },
  {
    title: "VIDEO",
    items: [
      ...
      { type: "video-as-prompt"    as const, label: "Video as Prompt",      icon: "📼",  color: "#0ea5e9" },
      { type: "frame-interpolation"as const, label: "Frame Interpolation",  icon: "🎞️",  color: "#0ea5e9" },
      { type: "video-audio-joint"  as const, label: "Video + Audio Joint",  icon: "🎬",  color: "#0ea5e9" },
      ...
      { type: "subtitle-generator" as const, label: "Subtitles",            icon: "💬",  color: "#f59e0b" },
    ],
  },
  {
    title: "AUDIO",
    items: [
      ...
      { type: "tts"             as const, label: "TTS (VoxCPM)",      icon: "🗣️", color: "#ef4444" },
      { type: "singer"          as const, label: "AI Singer",         icon: "🎤",  color: "#ef4444" },
      { type: "speech-synth"    as const, label: "Speech Synthesis",  icon: "🎙️", color: "#ef4444" },
      { type: "beat-detection"  as const, label: "Beat Detection",    icon: "🥁",  color: "#ef4444" },
    ],
  },
  {
    title: "TEXT",
    items: [
      { type: "text-prompt" as const, label: "Text",       icon: "T",   color: "#8b5cf6" },
      { type: "assistant"   as const, label: "Assistant",  icon: "✨",  color: "#6366f1" },
      { type: "translate"   as const, label: "Translate",  icon: "🌐",  color: "#14b8a6" },
    ],
  },
  {
    title: "UTILITIES",
