    ...
    <div className="min-h-screen bg-[#05080F] text-[#EAF2FF] flex justify-center selection:bg-[#38C2F0] selection:text-black">
      ...
      <div className="w-full max-w-[430px] min-h-screen relative overflow-hidden bg-gradient-to-b from-[#070D1F] via-[#0B1330] to-[#070D1F] pb-[160px]">
        ...
        <section className="px-4 pt-3">
          ...
          <div className="flex justify-between text-[11px] text-slate-400 mt-1.5 font-mono px-1">
            <span>المدة المختارة: <b className="text-[#38C2F0]">{duration}s</b></span>
            <span>الحد الأقصى: <b className="text-slate-300">{selectedModel.durations[selectedModel.durations.length - 1]}s</b></span>
          </div>
        </section>
