...
const PLACEHOLDER_VIDEOS = [
  ...
  "https://videos.pexels.com/video-files/5680034/5680034-uhd_2560_1440_24fps.mp4",
...
const SCENES: Scene[] = [
  ...
  },
  {
    ...
    category: "Action",
    videoSrc: PLACEHOLDER_VIDEOS[10],
    hiddenPrompt:
  ...
  },
  {
    ...
    title: "Last Dance",
    category: "Emotional",
    videoSrc: PLACEHOLDER_VIDEOS[11],
    hiddenPrompt:
...
function SceneCard({
  ...
  return (
    <div className="group relative flex flex-col overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-xl transition-all duration-500 hover:scale-[1.02] hover:border-white/[0.12] hover:shadow-[0_0_40px_rgba(139,92,246,0.08)]">
      {/* video */}
      <div className="relative aspect-video w-full overflow-hidden">
        ...
        <span
          ...
          } px-3 py-0.5 text-[11px] font-semibold tracking-wide text-white shadow-lg backdrop-blur-sm`}
        >
          {scene.category}
        </span>
      </div>
      ...
      <div className="flex flex-1 flex-col gap-3 p-4">
        ...
        <button
          ...
          className="mt-auto flex items-center justify-center gap-2 rounded-xl border border-white/[0.06] bg-gradient-to-r from-violet-600/90 to-indigo-600/90 px-4 py-2.5 text-sm font-medium text-white shadow-lg shadow-violet-500/10 transition-all duration-300 hover:from-violet-500 hover:to-indigo-500 hover:shadow-violet-500/25 active:scale-[0.97]"
        >
          <svg
            className="h-4 w-4"
            fill="none"
        ...
        <div className="mx-auto mb-12 max-w-3xl">
          <div className="overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.03] shadow-2xl shadow-black/20 backdrop-blur-xl">
            ...
            <div className="flex flex-wrap items-center gap-3 border-t border-white/[0.04] px-5 py-3">
              ...
              <button
                className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-violet-500/20 transition-all duration-300 hover:shadow-violet-500/40 active:scale-[0.97] disabled:opacity-40"
