    ...
    >
      ...
      >
        <div className="flex flex-col gap-5 p-4 flex-1">
          ...
          {/* Consolidated Reference Status Bar */}
              ...
              <div className="flex items-center justify-between gap-1.5 rounded-xl bg-black/20 p-1.5 border border-white/[0.03]">
                <div className="flex items-center gap-1">
                  ...
                  <button
                    ...
                    className="relative w-[30px] h-[30px] rounded-lg bg-[#121520] border border-slate-800 flex flex-col items-center justify-center transition-all duration-200 hover:bg-[#191d2c] group cursor-pointer"
                    title={lang === "ar" ? "الصور المرجعية" : "Reference Images"}
                  >
                    <ImageIcon className={`w-4 h-4 transition-all ${referenceImages.some(f => f.type.startsWith("image/")) ? "text-cyan-400" : "text-slate-500 group-hover:text-slate-400"}`} />
                    <div
                  ...
                  >
                    <Film className={`w-4 h-4 transition-all ${referenceImages.some(f => f.type.startsWith("video/")) ? "text-purple-400" : "text-slate-500 group-hover:text-slate-400"}`} />
                    <div
                      className={`absolute bottom-0 left-1 right-1 h-[2px] rounded-full transition-all ${
                  ...
                  >
                    <Volume2 className={`w-4 h-4 transition-all ${referenceImages.some(f => f.type.startsWith("audio/")) ? "text-teal-400" : "text-slate-500 group-hover:text-slate-400"}`} />
                    <div
                      className={`absolute bottom-0 left-1 right-1 h-[2px] rounded-full transition-all ${
                  ...
                  >
                    <User className={`w-4 h-4 transition-all ${selectedCharacterPresetId ? "text-pink-400" : "text-slate-500 group-hover:text-slate-400"}`} />
                    <div
                      className={`absolute bottom-0 left-1 right-1 h-[2px] rounded-full transition-all ${
                  ...
                  >
                    <Palette className={`w-4 h-4 transition-all ${selectedStyle ? "text-amber-400" : "text-slate-500 group-hover:text-slate-400"}`} />
                    <div
                      className={`absolute bottom-0 left-1 right-1 h-[2px] rounded-full transition-all ${
                        selectedStyle
                ...
                <button
                  ...
                  className="flex-1 h-[30px] rounded-lg border border-dashed border-slate-700 hover:border-cyan-500/80 bg-cyan-500/5 hover:bg-cyan-500/10 flex items-center justify-center gap-1 transition-all duration-200 cursor-pointer text-cyan-400 hover:text-white min-w-0"
                >
