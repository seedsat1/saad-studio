...
async function ensureCMSSeed(){try{const cms=await loadCMS();let changed=false;if(!cms.pages||!cms.pages.length){const now=new Date().toISOString();cms.pages=[{id:cmsId(),title:'الرئيسية',slug:'home',category:'main',visible:true,published:true,order:0,seoTitle:'SAAD STUDIO - ذكاء اصطناعي إبداعي',seoDescription:'منصة SAAD STUDIO للذكاء الاصطناعي الإبداعي',sections:[{id:cmsId(),type:'hero',label:'القسم الرئيسي',enabled:true,order:0,data:{title:'SAAD STUDIO',subtitle:'منصة الذكاء الاصطناعي الإبداعي',description:'أنشئ صور ومقاطع فيديو مذهلة بالذكاء الاصطناعي.',buttonText:'ابدأ الآن',buttonLink:'/#tools'},createdAt:now,updatedAt:now},{id:cmsId(),type:'features',label:'مميزات المنصة',enabled:true,order:1,data:{title:'لماذا SAAD STUDIO؟',items:['توليد صور احترافية','إنشاء فيديو بالذكاء الاصطناعي','أدوات تحرير متقدمة']},createdAt:now,updatedAt:now}],createdAt:now,updatedAt:now},{id:cmsId(),title:'من نحن',slug:'about',category:'main',visible:true,published:true,order:1,seoTitle:'من نحن - SAAD STUDIO',seoDescription:'تعرف على منصة SAAD STUDIO وفريق العمل',sections:[{id:cmsId(),type:'text',label:'نص تعريفي',enabled:true,order:0,data:{title:'من نحن',description:'SAAD STUDIO منصة متخصصة في الذكاء الاصطناعي الإبداعي.'},createdAt:now,updatedAt:now}],createdAt:now,updatedAt:now},{id:cmsId(),title:'تواصل معنا',slug:'contact',category:'main',visible:true,published:true,order:2,seoTitle:'تواصل معنا - SAAD STUDIO',seoDescription:'تواصل مع فريق SAAD STUDIO',sections:[{id:cmsId(),type:'contact',label:'نموذج التواصل',enabled:true,order:0,data:{title:'تواصل معنا',email:'info@saadstudio.com',description:'يسعدنا سماع استفساراتك.'},createdAt:now,updatedAt:now}],createdAt:now,updatedAt:now},{id:cmsId(),title:'Legal',slug:'legal',category:'legal',visible:true,published:true,order:10,seoTitle:'الشروط والأحكام - SAAD STUDIO',seoDescription:'شروط الاستخدام وسياسة الخصوصية وسياسة الاسترداد',sections:[{id:cmsId(),type:'richtext',label:'شروط الاستخدام',enabled:true,order:0,data:{title:'شروط الاستخدام',icon:'📋',body:'بالدخول إلى منصة SAAD STUDIO أو استخدامها، فإنك توافق على الالتزام بهذه الشروط والأحكام.\n\n**1. قبول الشروط**\nباستخدام المنصة تقر بأنك قرأت وفهمت ووافقت على هذه الشروط.\n\n**2. الاستخدام المسموح به**\nيُسمح باستخدام المنصة للأغراض الشخصية والتجارية المشروعة. يُحظر استخدام المنصة لأغراض غير قانونية أو مضرة.\n\n**3. الملكية الفكرية**\nجميع المحتوى المُولَّد عبر المنصة يخضع لسياسات النماذج المستخدمة. تحتفظ SAAD STUDIO بحقوق المنصة وتصميمها.\n\n**4. تحديد المسؤولية**\nلا تتحمل SAAD STUDIO مسؤولية أي أضرار ناتجة عن استخدام المنصة أو المحتوى المُولَّد.\n\n**5. التعديلات**\nنحتفظ بالحق في تعديل هذه الشروط في أي وقت مع إشعار المستخدمين.'},createdAt:now,updatedAt:now},{id:cmsId(),type:'richtext',label:'سياسة الخصوصية',enabled:true,order:1,data:{title:'سياسة الخصوصية',icon:'🔒',body:'نحن في SAAD STUDIO نحترم خصوصيتك ونلتزم بحماية بياناتك الشخصية.\n\n**1. البيانات التي نجمعها**\nنجمع البريد الإلكتروني، بيانات الاستخدام، والمحتوى الذي تُولّده عبر المنصة.\n\n**2. كيفية الاستخدام**\nنستخدم بياناتك لتحسين الخدمة، ومعالجة المدفوعات، والتواصل معك بشأن حسابك.\n\n**3. مشاركة البيانات**\nلا نبيع بياناتك لأطراف ثالثة. قد نشارك بيانات مجهولة لتحسين النماذج.\n\n**4. الأمان**\nنستخدم تشفيراً من الدرجة الأولى لحماية بياناتك.\n\n**5. حقوقك**\nيحق لك طلب حذف بياناتك أو تصديرها في أي وقت عبر التواصل معنا.'},createdAt:now,updatedAt:now},{id:cmsId(),type:'richtext',label:'سياسة الاسترداد',enabled:true,order:2,data:{title:'سياسة الاسترداد والإلغاء',icon:'💳',body:'نسعى إلى ضمان رضاك التام عن خدماتنا.\n\n**1. الكريدت غير المستخدم**\nيمكن استرداد الكريدت غير المستخدم خلال 7 أيام من الشراء.\n\n**2. الاشتراكات**\nيمكن إلغاء الاشتراك في أي وقت. لن يتم الخصم في دورة الفوترة التالية.\n\n**3. حالات الاسترداد**\nيتم الاسترداد في حالة تعطل الخدمة لفترة تتجاوز 24 ساعة أو وجود أخطاء في الفوترة.\n\n**4. طريقة الاسترداد**\nيتم الاسترداد عبر نفس طريقة الدفع الأصلية خلال 5-10 أيام عمل.\n\n**5. التواصل**\nللاستفسار عن الاسترداد، تواصل معنا عبر البريد الإلكتروني.'},createdAt:now,updatedAt:now}],createdAt:now,updatedAt:now}];changed=true;console.log('  ✅ CMS: تم إنشاء الصفحات الافتراضية');}// Always ensure legal page exists even if other pages were already seeded
if(Array.isArray(cms.pages)&&!cms.pages.find(p=>p.slug==='legal')){const now=new Date().toISOString();cms.pages.push({id:cmsId(),title:'Legal',slug:'legal',category:'legal',visible:true,published:true,order:10,seoTitle:'الشروط والأحكام - SAAD STUDIO',seoDescription:'شروط الاستخدام وسياسة الخصوصية وسياسة الاسترداد',sections:[{id:cmsId(),type:'richtext',label:'شروط الاستخدام',enabled:true,order:0,data:{title:'شروط الاستخدام',icon:'📋',body:'بالدخول إلى منصة SAAD STUDIO أو استخدامها، فإنك توافق على الالتزام بهذه الشروط والأحكام.\n\n**1. قبول الشروط**\nباستخدام المنصة تقر بأنك قرأت وفهمت ووافقت على هذه الشروط.\n\n**2. الاستخدام المسموح به**\nيُسمح باستخدام المنصة للأغراض الشخصية والتجارية المشروعة. يُحظر استخدام المنصة لأغراض غير قانونية أو مضرة.\n\n**3. الملكية الفكرية**\nجميع المحتوى المُولَّد عبر المنصة يخضع لسياسات النماذج المستخدمة. تحتفظ SAAD STUDIO بحقوق المنصة وتصميمها.\n\n**4. تحديد المسؤولية**\nلا تتحمل SAAD STUDIO مسؤولية أي أضرار ناتجة عن استخدام المنصة أو المحتوى المُولَّد.\n\n**5. التعديلات**\nنحتفظ بالحق في تعديل هذه الشروط في أي وقت مع إشعار المستخدمين.'},createdAt:now,updatedAt:now},{id:cmsId(),type:'richtext',label:'سياسة الخصوصية',enabled:true,order:1,data:{title:'سياسة الخصوصية',icon:'🔒',body:'نحن في SAAD STUDIO نحترم خصوصيتك ونلتزم بحماية بياناتك الشخصية.\n\n**1. البيانات التي نجمعها**\nنجمع البريد الإلكتروني، بيانات الاستخدام، والمحتوى الذي تُولّده عبر المنصة.\n\n**2. كيفية الاستخدام**\nنستخدم بياناتك لتحسين الخدمة، ومعالجة المدفوعات، والتواصل معك بشأن حسابك.\n\n**3. مشاركة البيانات**\nلا نبيع بياناتك لأطراف ثالثة. قد نشارك بيانات مجهولة لتحسين النماذج.\n\n**4. الأمان**\nنستخدم تشفيراً من الدرجة الأولى لحماية بياناتك.\n\n**5. حقوقك**\nيحق لك طلب حذف بياناتك أو تصديرها في أي وقت عبر التواصل معنا.'},createdAt:now,updatedAt:now},{id:cmsId(),type:'richtext',label:'سياسة الاسترداد',enabled:true,order:2,data:{title:'سياسة الاسترداد والإلغاء',icon:'💳',body:'نسعى إلى ضمان رضاك التام عن خدماتنا.\n\n**1. الكريدت غير المستخدم**\nيمكن استرداد الكريدت غير المستخدم خلال 7 أيام من الشراء.\n\n**2. الاشتراكات**\nيمكن إلغاء الاشتراك في أي وقت. لن يتم الخصم في دورة الفوترة التالية.\n\n**3. حالات الاسترداد**\nيتم الاسترداد في حالة تعطل الخدمة لفترة تتجاوز 24 ساعة أو وجود أخطاء في الفوترة.\n\n**4. طريقة الاسترداد**\nيتم الاسترداد عبر نفس طريقة الدفع الأصلية خلال 5-10 أيام عمل.\n\n**5. التواصل**\nللاستفسار عن الاسترداد، تواصل معنا عبر البريد الإلكتروني.'},createdAt:now,updatedAt:now}],createdAt:now,updatedAt:now});changed=true;console.log('  ✅ CMS: تمت إضافة صفحة Legal');}
