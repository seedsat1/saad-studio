...
SETS.styles = [
  ...
  ["papercraft", `Low-poly papercraft sculpture scene. Two stylised human figures mid-stride, built entirely from folded matte cardstock with flat faceted planes, crisp creases and visible cut edges. Backdrop of layered cut-paper circles in soft gold and cobalt blue with pleated paper fans and delicate paper foliage. Soft diffused studio light raking across the folds, gentle shadows between sheets, shallow depth of field, handmade paper-diorama craft. ${NO_TEXT}`],
  ["eighties", `A genuine 1985 amateur photograph of a young Iraqi woman, direct on-camera flash, faded analog colour and heavy film grain. Big teased dark hair, blue eyeshadow, gold hoop earrings and a bold magenta and blue shoulder-padded blazer, standing against a beige domestic wall with wood panelling. A period-accurate red-orange date stamp reading OCT 26 '85 in the lower right corner. No modern objects, and no text other than that date stamp. No watermark, no logo, no caption bar, no border frame.`],
