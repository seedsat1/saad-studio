...
- Until a real authenticated image provider bridge is connected, inline image-generation requests should explain that real generation is not configured and provide a usable prompt only as a fallback.
