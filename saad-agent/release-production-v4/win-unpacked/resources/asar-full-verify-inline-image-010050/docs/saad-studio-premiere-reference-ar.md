...
- If no real authenticated image provider bridge is configured, Saad Agent should say that real image generation is not connected yet and provide the prompt as a fallback only.
