...
export class ChatOrchestratorService {
        ...
        if (!normalizedAttachments.length) {
            ...
            if (ModelExpertiseExtractionService.isExtractionRequest(userRequestText)) {
                ...
                if (extractionTopics.length > 1) {
                    const batch = await ModelExpertiseExtractionService.extractBatchFromLocalModel({
                ...
                const extraction = await ModelExpertiseExtractionService.extractFromLocalModel({
                    workspacePath: activeWorkspace,
                    prompt: userRequestText,
                    signal: input.signal
                });
    ...
    static isUrlContentReadRequest(prompt, normalized) {
        ...
        if (!/https?:\/\/[^\s)>\]"]+/i.test(prompt))
            return false;
        const readSignal = /(?:^|\s)(?:\u0627\u0642\u0631\u0627|\u0627\u0641\u062a\u062d|\u0641\u062a\u062d|\u0644\u062e\u0635|\u062d\u0644\u0644)(?:\s|$)/i.test(normalized)
            || /(?:\u0645\u062d\u062a\u0648\u0627\u0647|\u0645\u062d\u062a\u0648\u0649|\u0627\u0644\u0635\u0641\u062d\u0647|\u0627\u0644\u0635\u0641\u062d\u0629)/i.test(normalized)
            || /\b(read|open|summarize|analyse|analyze|content|page)\b/i.test(lower);
