...
function AppTile(app: AppDef): HTMLElement {
  return el("button.app-tile",
    { onClick: () => navigate(app.route) },
    app.badge ? el("span.app-tile__badge", null, app.badge) : null,
    el("div.app-tile__icon", null, icon(app.icon, 18)),
    el("div.col.gap-1",
      null,
      el("div.app-tile__name", null, app.name),
      el("div.app-tile__desc", null, app.description),
    ),
  );
}
