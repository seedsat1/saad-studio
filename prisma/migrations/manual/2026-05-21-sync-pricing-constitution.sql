-- Manual migration: sync PricingConstitution to the code pricing floor.
--
-- The app reads PricingConstitution before falling back to DEFAULT_MODELS.
-- Run this after pricing changes so the DB reference cannot keep stale,
-- underpriced rows such as old Seedance 2.0 or Kling 3.0 values.
...
ON CONFLICT ("id") DO UPDATE SET
  ...
  "kieCredits"      = GREATEST("PricingConstitution"."kieCredits", EXCLUDED."kieCredits"),
  "waveUsd"         = GREATEST("PricingConstitution"."waveUsd", EXCLUDED."waveUsd"),
  "userCreditsRate" = GREATEST("PricingConstitution"."userCreditsRate", EXCLUDED."userCreditsRate"),
  "maxDuration"     = EXCLUDED."maxDuration",
  "isActive"        = EXCLUDED."isActive",
  "updatedAt"       = NOW();

DELETE FROM "PricingConstitution"
WHERE "id" IN ('kling30_omni', 'kling30_edit');
