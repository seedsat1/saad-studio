...
const TOUR_STEPS_EN: TourStep[] = [
  {
    id: 1,
    stepLabel: "1 of 15 - Talents",
    title: "Welcome to AI Talent Studio",
    description: "Create one reusable AI persona and call it anywhere with an @handle.",
    tabKey: "influencers",
    highlightSelector: "#tour-influencer-grid",
  },
  {
    id: 2,
    stepLabel: "2 of 15 - Talents",
    title: "Your talents live here",
    description: "This roster is the base library for every trained persona.",
    tabKey: "influencers",
    highlightSelector: "#tour-influencers-roster",
  },
  {
    id: 3,
    stepLabel: "3 of 15 - Training",
    title: "Create the persona once",
    description: "Add a name, @handle, and a clear face reference. Then reuse it across every studio.",
    tabKey: "influencers",
    highlightSelector: "#tour-add-influencer-card",
  },
  {
    id: 4,
    stepLabel: "4 of 15 - Default",
    title: "Start with Gavi",
    description: "The default talent lets you test image, video, canvas, and face swap flows immediately.",
    tabKey: "influencers",
