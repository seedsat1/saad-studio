...
- Changes:
  ...
  - Fixed language toggle binding on `/plugin` page ([app/(landing)/(routes)/plugin/page.tsx](file:///e:/%D9%85%D9%88%D9%82%D8%B9%20%D8%AB%D8%A7%D9%86%D9%8A/next14%20ai%20saas/next14-ai-saas-main/next14-ai-saas-main/app/%28landing%29/%28routes%29/plugin/page.tsx)): resolved variable destructuring mismatch (`lang` vs `language`) and added `language` alias in [lib/use-language.ts](file:///e:/%D9%85%D9%88%D9%82%D8%B9%20%D8%AB%D8%A7%D9%86%D9%8A/next14%20ai%20saas/next14-ai-saas-main/next14-ai-saas-main/lib/use-language.ts) so toggling between English and Arabic updates the page instantly.
- Verification:
  - Verified local build (`npm run build`) succeeded with zero errors (`✓ Compiled successfully`).
  - Pushed commit `e4733af` to main repository (`saad-studio`).
