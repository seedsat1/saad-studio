...
- Changes:
  ...
  - Updated ZXP installer button in Step 1 on `/plugin` page ([app/(landing)/(routes)/plugin/page.tsx](file:///e:/%D9%85%D9%88%D9%82%D8%B9%20%D8%AB%D8%A7%D9%86%D9%8A/next14%20ai%20saas/next14-ai-saas-main/next14-ai-saas-main/app/%28landing%29/%28routes%29/plugin/page.tsx)) to link directly to official setup executable: `https://updates.aescripts.com/win/aescripts%20+%20aeplugins%20desktop%20apps%20%28setup%29.exe`.
- Verification:
  - Verified local build (`npm run build`) completed successfully with zero errors (`✓ Compiled successfully`).
  - Pushed commit `fd4d987` to main repository (`saad-studio`).
