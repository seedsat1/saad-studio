...
- **المشكلة**:
  ...
  - 480p: حساب تناسبي تماماً بمعدل 1.0 كريديت لكل ثانية (15 ثانية = 15 كريديت).
  - 720p: حساب بمعادلة خطية تبدأ من 10 كريديت لـ 4 ثوانٍ وحتى 38 كريديت لـ 15 ثانية (معادلة: `(28 / 11) * duration - 2 / 11`).
  - حساب الكريديت تناسبي وصيغي دقيق مع مدة الفيديو، دون المساس بأي تسعير آخر.
