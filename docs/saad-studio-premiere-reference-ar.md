...
## توسيع صندوق كتابة البرومبت رئيسياً للأعلى في واجهة الاستوديو (2026-07-25)

- تم تحديث تصميم صندوق مدخلات البرومبت في صفحات الاستوديو (`/video`, `/image`):
  1. **التوسيع الرأسي للأعلى**: تم استخدام `items-end` وارتفاع ديناميكي يبدأ من `58px` وحتى `240px` بحيث يتوسع الحقل **رأسياً للأعلى** عند كتابة أو لصق نصوص طويلة دون إخفاء الكلمات أو تراكب الأزرار.
  2. **تحسين الرؤية والأسطر**: أصبح حقل النص يدعم عرض متعدد الأسطر (`rows=2` إلى `6`) مع شريط التمرير المخصص وإمكانية السحب الرأسي التفاعلي (`resize-y`).
