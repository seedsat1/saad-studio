...
## ربط نموذج Google Gemini Omni بمزود المعالجة السريع Kie (`gemini-omni-video`) (2026-07-25)

- تم تشخيص السبب الفعلي لحالة المعالجة المتبقية وتحسين التوجيه:
  1. **التوجيه لمزود الخدمة السريع**: كانت طلبات `google/gemini-omni-flash` توجّه سابقاً إلى واجهة كوكل التجريبية المباشرة والتي قد تتعلق في حالة المعالجة.
  2. **المطابقة مع Higgsfield**: تم تحويل التوجيه ليستخدم نموذج `gemini-omni-video` عبر سيرفرات Kie السريعة (نفس مزود الخدمة المعتمَد في Higgsfield) مما يعالج الفيديوهات بسرعة وثبات عاليين دون تعليق.
