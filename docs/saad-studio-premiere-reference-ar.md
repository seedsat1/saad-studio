...
- القيمة الافتراضية المثبتة حالياً لنسبة Wan 3.0 هي `16:9` فقط لأنها النسبة الموثقة في صور المزود المرفقة.
...
- القيود المثبتة حالياً:
  ...
  - نسبة العرض الموثقة في صور المزود: `16:9`.
...
- مصدر الأسعار هو لقطات المالك من واجهة المزود، وليست تقديراً:
  - `480p`: ثانيتان = `$0.10` و30 ثانية = `$1.50`، أي `$0.05/sec`.
  - `720p`: ثانيتان = `$0.20` و30 ثانية = `$3.00`، أي `$0.10/sec`.
  - `1080p`: ثانيتان = `$0.40` و30 ثانية = `$6.00`، أي `$0.20/sec`.
- قاعدة هامش المنصة الحالية محفوظة كما هي: `40 credits/USD * 1.4 = 56 credits لكل دولار مصدر`.
- أسعار المشترك النهائية لمسارات `alibaba/wan-3.0/*`:
  - `480p`: `2.8 cr/sec`، 30 ثانية = `84 cr`، ثانيتان = `5.6 cr`.
  - `720p`: `5.6 cr/sec`، 30 ثانية = `168 cr`، ثانيتان = `11.2 cr`.
  - `1080p`: `11.2 cr/sec`، 30 ثانية = `336 cr`، ثانيتان = `22.4 cr`.
- تم ربط السعر في طبقتين:
  - سعر المشترك: `lib/pricing.ts` و`lib/credit-pricing.ts`.
  - تكلفة المصدر ومراقبة المزود: `lib/provider-tariff-registry.ts` تحت WaveSpeed مع `verified_manual` provenance.
